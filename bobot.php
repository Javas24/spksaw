            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <a href="bobot-add.php" class="btn btn-primary btn-sm">Tambah Kriteria</a>
                </div>
...
while ($row = $result->fetch_object()) {
    echo "<tr>
        ...
        <td>
          ...
          <a href='bobot-delete.php?id={$row->id_criteria}' class='btn btn-danger btn-sm' onclick=\"return confirm('Yakin ingin menghapus kriteria ini?');\">Hapus</a>
        </td>
      </tr>\n";
}
$result->free();
